export const id = {
  ...
  // HomeScreen
  marqueeWelcome: ["Selamat", "datang", "di", "portofolio", "G"],
  dearVisitor: "pengunjung yang terhormat,",
  bioP1: "portofolio ini mewakili perjalanan saya sebagai web developer — tempat untuk ",
  bioCreative: "eksperimen kreatif",
  bioP2: "; di mana coding bertemu dengan desain dan kafein menjadi bahan bakar yang ajaib.",
  warmly: "salam hangat,",
  fromLocation: "(dari pvnkalpinang)",
  ...
  // InfoScreen
  infoTitle: ["Bio", "Tentang Saya"],
  aboutP1: "Hai, Saya Giandri Aditio, seorang Web Developer dan Desainer Grafis dengan pengalaman magang dan proyek independen dalam pengembangan web. Lulusan Sarjana Teknik Informatika dari ISB Atma Luhur Pangkal Pinang dengan IPK 3.84.",
  aboutP2: "Memiliki keterampilan kuat dalam animasi web, Tailwind CSS, Next.js, dan Laravel. Selain itu, memiliki minat besar pada desain grafis dan fotografi, khususnya fotografi panggung dan band, yang semakin meningkatkan kemampuan kreatif.",
  roleSubtitle: "Web Developer & Desainer",
  getInTouch: "Hubungi Saya",
  skills: {
    webDev: "Web Development",
    visualCreative: "Kreatif Visual",
    coffeeEnthusiast: "Minat Kopi"
  }
};
