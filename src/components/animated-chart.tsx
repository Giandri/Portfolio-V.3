    ...
    >
      ...
      <div className="relative flex-1 flex flex-col justify-end border-t border-border/10">
        ...
        <motion.div
          ...
          className={cn("relative w-full border-t-2 border-border/30 bg-black dark:bg-white", columnClassName, topBorderClassName)}
          initial={{ height: 0 }}
          animate={barControls}
        >
          ...
          <motion.span
            ...
            className={cn(
              "absolute top-2 left-3 text-base font-normal text-background dark:text-foreground",
              globalValueClassName,
              columnValueClassName,
            )}
            initial={{ opacity: 0 }}
